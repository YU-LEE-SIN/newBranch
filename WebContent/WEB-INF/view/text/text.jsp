	...
	<body>
		<div id="nav1" class="nav-wrapper">
			...
			<ul class="right search-wrapper">
				...
				<li><a href="/textviewcart" class="iconfont icon-gouwuchexian"></a></li>
				...
				<div class="content1">
					...
					<div class="product-intro col l6 m12 s12">
						<div class="product-intro-price">
							<h5 id="${product.pk_pid}">${product.pname}</h5>
					 		...
					 		<c:forEach var="pr" end="0" items="${productspe}">
								<c:choose>
									...
									<c:when test="${pr.prt_sp_two_name==null }">
										<h5 id="productspename">${pr.prt_sp_one_name}</h5>
									</c:when>
									<c:otherwise>
							...
							<c:forEach var="pr" items="${productspe}">
								<c:choose>
									...
									<!-- <li class="col l5 m5 s12"><a href="/productDetails?pk_id=${pr.pk_id}&pid=${product.pk_pid}">${pr.prt_sp_one_name}<span></span>&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
									 -->
									<li class="col l5 m5 s12"><a href="/productDetails?pk_id=${pr.pk_id}&pid=${product.pk_pid}">${pr.prt_sp_two_name}<span></span>&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
						...
						<div class="product-intro-car">
							...
							<input type="text">
							<a id="aa" href="/textaddToCart?pk_pid=${proudctspe.pk_id}" class="right btn">购买单品</a>
							<p>标签:${proudctspe.pk_id}</p>
							<div class="clearfix"></div>
		...
		<script>
			$(".btnsuper").click(function(){
				 ...
				 $.getJSON("productDetails",parmams,function(data){
					$("#productspename").text(data.prt_sp_one_name);
					$("#productspeprice").text(data.prt_sp_price);
					$("#aa").attr("href","/textaddToCart?pk_pid="+data.pk_id);
				})
			})		
		</script>
